...
#pragma acc kernels deviceptr(wrongval_d)
	{ wrongval_d[0] = false; }
	wrongval_h[0] = false;

#pragma acc kernels deviceptr(elec_coord, elec_coord2, wrongval_d)
	{
...
#pragma acc kernels deviceptr(nucl_coord, nucl_coord2, wrongval_d)
	{
...
#pragma acc kernels deviceptr(nucl_coord, nucl_coord2, wrongval_d)
	...
	rc = qmckl_get_nucleus_charge_device(context, nucl_charge2, nucl_num);
	for (int64_t i = 0; i < nucl_num; ++i) {
#pragma acc kernels deviceptr(nucl_charge, nucl_charge2, wrongval_d)
		{
...
#pragma acc kernels deviceptr(k_en, rescale_factor_en, wrongval_d)
	{
...
#pragma acc kernels deviceptr(asymp_jasb, wrongval_d)
	{
	...
	// calculate factor_ee
	rc = qmckl_get_jastrow_factor_ee_device(context, factor_ee, walk_num);
#pragma acc kernels deviceptr(factor_ee, wrongval_d)
	{
...
#pragma acc kernels deviceptr(factor_ee_deriv_e, wrongval_d)
	{
...
#pragma acc kernels deviceptr(ee_distance_rescaled, wrongval_d)
	{
		// (e1,e2,w)
		// (0,0,0) == 0.
...
#pragma acc kernels deviceptr(factor_en, wrongval_d)
	{
		// BUG fails at 1.e-4
...
#pragma acc kernels deviceptr(factor_en_deriv_e, wrongval_d)
	{
	...
	// BUG fails at 1.e-4
#pragma acc kernels deviceptr(en_distance_rescaled, wrongval_d)
	{
...
#pragma acc kernels deviceptr(een_rescaled_e, wrongval_d)
	{
...
#pragma acc kernels deviceptr(een_rescaled_e_deriv_e, wrongval_d)
	{
		// value of (0,0,0,2,1)
...
#pragma acc kernels deviceptr(een_rescaled_n, wrongval_d)
	{
		// value of (0,2,1)
...
// value of (0,2,1)
#pragma acc kernels deviceptr(een_rescaled_n_deriv_e, wrongval_d)
	{
...
#pragma acc kernels deviceptr(tmp_c, dtmp_c, wrongval_d)
	{
...
#pragma acc kernels deviceptr(factor_een, wrongval_d)
	{
...
#pragma acc kernels deviceptr(factor_een_deriv_e, wrongval_d)
	{
...
#pragma acc kernels deviceptr(total_j, factor_ee, factor_en, factor_een,       \
							  wrongval_d)
	{
