...
qmckl_exit_code qmckl_set_error(qmckl_context context,
...
qmckl_exit_code qmckl_failwith(qmckl_context context,
	...
	if (message == NULL) {
		qmckl_exit_code rc = qmckl_set_error(context, exit_code, function,
...
qmckl_exit_code qmckl_set_electron_coord(qmckl_context context,
										 const char transp,
...
qmckl_exit_code qmckl_get_electron_num(const qmckl_context context,
									   int64_t *const num) {
...
qmckl_exit_code qmckl_get_nucleus_num(const qmckl_context context,
									  int64_t *const num) {
...
qmckl_exit_code qmckl_set_nucleus_num(qmckl_context context,
									  const int64_t num) {
	int32_t mask = 1 << 0;
...
qmckl_exit_code qmckl_set_nucleus_charge(qmckl_context context,
										 const double *charge,
										 const int64_t size_max) {
	int32_t mask = 1 << 1;
...
qmckl_exit_code qmckl_set_nucleus_coord(qmckl_context context,
...
qmckl_exit_code qmckl_free(qmckl_context context, void *const ptr) {
	...
	if (qmckl_context_check(context) == QMCKL_NULL_CONTEXT) {
		return qmckl_failwith(context, QMCKL_INVALID_CONTEXT, "qmckl_free",
							  NULL);
	}

	if (ptr == NULL) {
		return qmckl_failwith(context, QMCKL_INVALID_ARG_2, "qmckl_free",
							  "NULL pointer");
	}
...
qmckl_exit_code qmckl_get_malloc_info(qmckl_context context, const void *ptr,
...
qmckl_exit_code qmckl_set_point(qmckl_context context, const char transp,
...
qmckl_exit_code qmckl_get_ao_basis_ao_num(const qmckl_context context,
...
qmckl_exit_code qmckl_get_ao_basis_shell_num(const qmckl_context context,
...
qmckl_exit_code qmckl_get_ao_basis_prim_num(const qmckl_context context,
...
qmckl_exit_code qmckl_get_ao_basis_type(const qmckl_context context,
...
qmckl_exit_code qmckl_get_mo_basis_mo_num(const qmckl_context context,
										  int64_t *mo_num) {
	if (qmckl_context_check(context) == QMCKL_NULL_CONTEXT) {
		return qmckl_failwith(context, QMCKL_INVALID_CONTEXT,
