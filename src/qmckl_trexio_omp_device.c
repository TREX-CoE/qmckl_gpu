...
qmckl_exit_code qmckl_set_point_omp_device(qmckl_context_device context,
  ...
  if (size_max < 3 * num) {
    return qmckl_failwith(context, QMCKL_INVALID_ARG_4,
                          "qmckl_set_point_omp_device", "Array too small");
  }

  if (transp != 'N' && transp != 'T') {
    return qmckl_failwith(context, QMCKL_INVALID_ARG_2,
                          "qmckl_set_point_omp_device",
                          "transp should be 'N' or 'T'");
  }

  if (coord == NULL) {
    return qmckl_failwith(context, QMCKL_INVALID_ARG_3,
                          "qmckl_set_point_omp_device", "coord is a NULL pointer");
  }
  ...
  if (num != ctx->point.num) {
    ...
    if (ctx->point.coord.data != NULL) {
      rc = qmckl_matrix_free_omp_device(context, &(ctx->point.coord), device_id);
      assert(rc == QMCKL_SUCCESS);
    }

    ctx->point.coord = qmckl_matrix_alloc_omp_device(context, num, 3, device_id);
    if (ctx->point.coord.data == NULL) {
      return qmckl_failwith((qmckl_context) context, QMCKL_ALLOCATION_FAILED, "qmckl_set_point",
                            NULL);
    }
  };
...
qmckl_exit_code qmckl_set_electron_coord_omp_device(
  ...
  if (mask != 0 && !(ctx->electron.uninitialized & mask)) {
    return qmckl_failwith(context, QMCKL_ALREADY_SET, "qmckl_set_electron_*",
                          NULL);
  }

  if (transp != 'N' && transp != 'T') {
    return qmckl_failwith(context, QMCKL_INVALID_ARG_2,
                          "qmckl_set_electron_coord_omp_device",
                          "transp should be 'N' or 'T'");
  }

  if (walk_num <= 0) {
    return qmckl_failwith(context, QMCKL_INVALID_ARG_3,
                          "qmckl_set_electron_coord_omp_device", "walk_num <= 0");
  }
...
qmckl_exit_code qmckl_get_nucleus_num_omp_device(const qmckl_context_device context,
                                                 int64_t *const num) {
...
qmckl_exit_code qmckl_set_nucleus_charge_omp_device(qmckl_context_device context,
                                                    const double *charge,
  ...
  if (qmckl_context_check((qmckl_context) context) == QMCKL_NULL_CONTEXT) {
    return qmckl_failwith((qmckl_context) context, QMCKL_NULL_CONTEXT,
                          "qmckl_set_nucleus_charge_omp_device", NULL);
  }
  ...
  if (charge == NULL) {
    return qmckl_failwith(context, QMCKL_INVALID_ARG_2,
                          "qmckl_set_nucleus_charge_omp_device",
  ...
  if (num > size_max) {
    return qmckl_failwith(context, QMCKL_INVALID_ARG_3,
                          "qmckl_set_nucleus_charge_omp_device", "Array too small");
  }

  ctx->nucleus.charge = qmckl_vector_alloc_omp_device(context, num, device_id);
  rc = qmckl_vector_of_double_omp_device(context, charge, num,
                                         &(ctx->nucleus.charge), device_id);
...
qmckl_exit_code qmckl_set_nucleus_coord_omp_device(qmckl_context_device context,
  ...
  if (ctx->nucleus.coord.data != NULL) {
    rc = qmckl_matrix_free_omp_device(context, &(ctx->nucleus.coord), device_id);
    if (rc != QMCKL_SUCCESS)
      return rc;
  }

  ctx->nucleus.coord =
      qmckl_matrix_alloc_omp_device(context, nucl_num, 3, device_id);

#pragma use_device_ptr(ctx->nucleus.coord.data)
  {
    if (ctx->nucleus.coord.data == NULL) {
      return qmckl_failwith((qmckl_context)context, QMCKL_ALLOCATION_FAILED,
                            "qmckl_set_nucleus_coord_omp_device", NULL);
    }
  }

  if (size_max < 3 * nucl_num) {
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_ARG_4,
                          "qmckl_set_nucleus_coord_omp_device", "Array too small");
  }

  if (transp == 'N') {
    qmckl_matrix At;
    At = qmckl_matrix_alloc_omp_device(context, 3, nucl_num, device_id);
    rc = qmckl_matrix_of_double_omp_device(context, coord, 3 * nucl_num, &At,
                                       device_id);
    if (rc != QMCKL_SUCCESS)
      return rc;
    rc = qmckl_transpose_omp_device(context, At, ctx->nucleus.coord);
  } else {
    rc = qmckl_matrix_of_double_omp_device(context, coord, nucl_num * 3,
                                       &(ctx->nucleus.coord), device_id);
  }
  if (rc != QMCKL_SUCCESS)
    return rc;
...
qmckl_exit_code qmckl_finalize_nucleus_basis_hpc_omp_device(qmckl_context_device context,
                                                    int device_id) {
  ...
  ctx->ao_basis.prim_num_per_nucleus =
      (int32_t *)qmckl_malloc_omp_device(context, mem_info, device_id);
...
#pragma omp target map(tofrom                                                  \
  ...
  ctx->ao_basis.coef_per_nucleus =
      qmckl_tensor_alloc_omp_device(context, 3, size, device_id);
  ctx->ao_basis.coef_per_nucleus =
      qmckl_tensor_set_omp_device(ctx->ao_basis.coef_per_nucleus, 0.);

  ctx->ao_basis.expo_per_nucleus =
      qmckl_matrix_alloc_omp_device(context, prim_max, nucl_num, device_id);
  ctx->ao_basis.expo_per_nucleus =
      qmckl_matrix_set_omp_device(ctx->ao_basis.expo_per_nucleus, 0.);
...
qmckl_exit_code qmckl_finalize_nucleus_basis_omp_device(qmckl_context_device context,
                                                int device_id) {

  if (qmckl_context_check((qmckl_context)context) == QMCKL_NULL_CONTEXT) {
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_CONTEXT,
                          "qmckl_finalize_nucleus_basis_omp_device", NULL);
  }
  ...
  /* nucleus_prim_index */
  {
    ...
    ctx->ao_basis.nucleus_prim_index =
        (int64_t *)qmckl_malloc_omp_device(context, mem_info, device_id);
      ...
      for (int64_t ishell = 0; ishell < shell_num; ++ishell) {
        for (int64_t iprim = shell_prim_index[ishell];
          ...
          coefficient_normalized[iprim] =
              coefficient[iprim] * prim_factor[iprim] * shell_factor[ishell];
        }
      }
    }
  }
...
#pragma omp target is_device_ptr(nucleus_range, nucleus_index,                 \
        ...
        for (int64_t inucl = 0; inucl < nucleus_num; ++inucl) {
          ...
          for (int64_t ishell = nucleus_index[inucl];
            ...
            for (int64_t iprim = shell_prim_index[ishell];
              ...
              nucleus_range[inucl] =
                  nucleus_range[inucl] > range ? nucleus_range[inucl] : range;
            }
          }
        }
      }
  ...
  rc = qmckl_finalize_nucleus_basis_hpc_omp_device(context, device_id);
...
qmckl_exit_code qmckl_finalize_ao_basis_hpc_omp_device(qmckl_context_device context,
                                                       int device_id) {
...
qmckl_exit_code qmckl_finalize_ao_basis_omp_device(qmckl_context_device context,
  ...
  if (qmckl_context_check((qmckl_context)context) == QMCKL_NULL_CONTEXT) {
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_CONTEXT,
                          "qmckl_finalize_ao_basis_omp_device", NULL);
  }
...
#pragma omp target is_device_ptr(nucleus_range, nucleus_index,                 \
  ...
  rc = qmckl_finalize_ao_basis_hpc_omp_device(context, device_id);
...
qmckl_exit_code qmckl_set_ao_basis_type_omp_device(qmckl_context_device context,
  ...
  if (qmckl_context_check((qmckl_context)context) == QMCKL_NULL_CONTEXT) {
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_CONTEXT,
                          "qmckl_set_ao_basis_type_omp_device", NULL);
  }
  ...
  if (ctx->ao_basis.provided) {
    qmckl_exit_code rc_ = qmckl_finalize_ao_basis_omp_device(context, device_id);
...
qmckl_set_ao_basis_shell_num_omp_device(qmckl_context_device context,
  ...
  if (qmckl_context_check((qmckl_context)context) == QMCKL_NULL_CONTEXT) {
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_CONTEXT,
                          "qmckl_set_ao_basis_shell_num_omp_device", NULL);
  }
  qmckl_context_struct *const ctx = (qmckl_context_struct *)context;

  if (shell_num <= 0) {
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_ARG_2,
                          "qmckl_set_ao_basis_shell_num_omp_device",
                          "shell_num <= 0");
  }
...
qmckl_exit_code qmckl_set_ao_basis_prim_num_omp_device(qmckl_context_device context,
                                                       const int64_t prim_num,
                                                       int device_id) {

  if (qmckl_context_check((qmckl_context)context) == QMCKL_NULL_CONTEXT) {
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_CONTEXT,
                          "qmckl_set_ao_basis_prim_num_omp_device", NULL);
  }
  qmckl_context_struct *const ctx = (qmckl_context_struct *)context;

  if (prim_num <= 0) {
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_ARG_2,
                          "qmckl_set_ao_basis_prim_num_omp_device",
...
qmckl_exit_code qmckl_set_ao_basis_ao_num_omp_device(qmckl_context_device context,
                                                     const int64_t ao_num,
                                                     int device_id) {
  if (qmckl_context_check((qmckl_context)context) == QMCKL_NULL_CONTEXT) {
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_CONTEXT,
                          "qmckl_set_ao_basis_ao_num_omp_device", NULL);
  }
  qmckl_context_struct *const ctx = (qmckl_context_struct *)context;
...
qmckl_exit_code
qmckl_set_ao_basis_nucleus_index_omp_device(qmckl_context_device context,
                                        const int64_t *nucleus_index,
                                        const int64_t size_max, int device_id) {
  if (qmckl_context_check((qmckl_context)context) == QMCKL_NULL_CONTEXT) {
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_CONTEXT,
                          "qmckl_set_ao_basis_nucleus_index_omp_device", NULL);
  }
  qmckl_context_struct *const ctx = (qmckl_context_struct *)context;
  ...
  if (nucl_num <= 0L) {
    return qmckl_failwith((qmckl_context)context, QMCKL_FAILURE,
                          "qmckl_set_ao_basis_nucleus_index_omp_device",
                          "nucl_num is not set");
  }
  ...
  if (ctx->ao_basis.nucleus_index != NULL) {
    qmckl_exit_code rc =
        qmckl_free_omp_device(context, ctx->ao_basis.nucleus_index, device_id);
    if (rc != QMCKL_SUCCESS) {
...
qmckl_exit_code qmckl_set_ao_basis_nucleus_shell_num_omp_device(
  ...
  if (nucl_num <= 0L) {
    return qmckl_failwith((qmckl_context)context, QMCKL_FAILURE,
                          "qmckl_set_ao_basis_nucleus_shell_num_omp_device",
                          "shell_num is not set");
  }
  ...
  if (ctx->ao_basis.nucleus_shell_num != NULL) {
    qmckl_exit_code rc =
        qmckl_free_omp_device(context, ctx->ao_basis.nucleus_shell_num, device_id);
    if (rc != QMCKL_SUCCESS) {
      return qmckl_failwith(
          context, rc, "qmckl_set_ao_basis_nucleus_shell_num_omp_device", NULL);
    }
  }
  ...
  if (new_array == NULL) {
    return qmckl_failwith((qmckl_context)context, QMCKL_ALLOCATION_FAILED,
                          "qmckl_set_ao_basis_nucleus_shell_num_omp_device", NULL);
  }
...
qmckl_exit_code
qmckl_set_ao_basis_shell_ang_mom_omp_device(qmckl_context_device context,
                                            const int32_t *shell_ang_mom,
                                            const int64_t size_max, int device_id) {

  if (qmckl_context_check((qmckl_context)context) == QMCKL_NULL_CONTEXT) {
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_CONTEXT,
                          "qmckl_set_ao_basis_shell_ang_mom_omp_device",
                          NULL);
  }
  qmckl_context_struct *const ctx = (qmckl_context_struct *)context;
  ...
  if (ctx->ao_basis.shell_ang_mom != NULL) {
    qmckl_exit_code rc =
        qmckl_free_omp_device(context, ctx->ao_basis.shell_ang_mom, device_id);
    if (rc != QMCKL_SUCCESS) {
      return qmckl_failwith((qmckl_context)context, rc,
                            "qmckl_set_ao_basis_shell_ang_mom_omp_device", NULL);
    }
  }
...
qmckl_exit_code qmckl_set_ao_basis_shell_prim_num_omp_device(
  ...
  if (qmckl_context_check((qmckl_context)context) == QMCKL_NULL_CONTEXT) {
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_CONTEXT,
                          "qmckl_set_ao_basis_nucleus_shell_prim_num_omp_device",
                          NULL);
  }
  qmckl_context_struct *const ctx = (qmckl_context_struct *)context;
  ...
  if (shell_num <= 0L) {
    return qmckl_failwith((qmckl_context)context, QMCKL_FAILURE,
                          "qmckl_set_ao_basis_shell_prim_num_omp_device",
                          "shell_num is not set");
  }
  ...
  if (ctx->ao_basis.shell_prim_num != NULL) {
    qmckl_exit_code rc =
        qmckl_free_omp_device(context, ctx->ao_basis.shell_prim_num, device_id);
    if (rc != QMCKL_SUCCESS) {
      return qmckl_failwith((qmckl_context)context, rc,
                            "qmckl_set_ao_basis_shell_prim_num_omp_device", NULL);
    }
  }
...
qmckl_exit_code qmckl_set_ao_basis_shell_prim_index_omp_device(
  ...
  if (qmckl_context_check((qmckl_context)context) == QMCKL_NULL_CONTEXT) {
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_CONTEXT,
                          "qmckl_set_ao_basis_shell_prim_index_omp_device", NULL);
  }
  qmckl_context_struct *const ctx = (qmckl_context_struct *)context;
  ...
  if (shell_num <= 0L) {
    return qmckl_failwith((qmckl_context)context, QMCKL_FAILURE,
                          "qmckl_set_ao_basis_shell_prim_index_omp_device",
                          "shell_num is not set");
  }
  ...
  if (ctx->ao_basis.shell_prim_index != NULL) {
    qmckl_exit_code rc =
        qmckl_free_omp_device(context, ctx->ao_basis.shell_prim_index, device_id);
    if (rc != QMCKL_SUCCESS) {
      return qmckl_failwith((qmckl_context)context, rc,
                            "qmckl_set_ao_basis_shell_prim_index_omp_device", NULL);
    }
  ...
  omp_target_memcpy(new_array, shell_prim_index, mem_info.size, 0, 0, device_id,
                    omp_get_initial_device());
...
qmckl_exit_code
qmckl_set_ao_basis_shell_factor_omp_device(qmckl_context_device context,
                                          const double *shell_factor,
                                          const int64_t size_max, int device_id) {

  if (qmckl_context_check((qmckl_context)context) == QMCKL_NULL_CONTEXT) {
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_CONTEXT,
                          "qmckl_set_ao_basis_shell_factor_omp_device", NULL);
  }
  qmckl_context_struct *const ctx = (qmckl_context_struct *)context;
  ...
  if (shell_num <= 0L) {
    return qmckl_failwith((qmckl_context)context, QMCKL_FAILURE,
                          "qmckl_set_ao_basis_shell_factor_omp_device",
                          "shell_num is not set");
  }
  ...
  if (ctx->ao_basis.shell_factor != NULL) {
    qmckl_exit_code rc =
        qmckl_free_omp_device(context, ctx->ao_basis.shell_factor, device_id);
    if (rc != QMCKL_SUCCESS) {
      return qmckl_failwith((qmckl_context)context, rc,
                            "qmckl_set_ao_basis_shell_factor_omp_device", NULL);
    }
...
qmckl_exit_code qmckl_set_ao_basis_exponent_omp_device(qmckl_context_device context,
                                                   const double *exponent,
                                                   const int64_t size_max,
                                                   int device_id) {
  if (qmckl_context_check((qmckl_context)context) == QMCKL_NULL_CONTEXT) {
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_CONTEXT,
                          "qmckl_set_ao_basis_exponent_omp_device", NULL);
  }
  qmckl_context_struct *const ctx = (qmckl_context_struct *)context;
  ...
  if (prim_num <= 0L) {
    return qmckl_failwith((qmckl_context)context, QMCKL_FAILURE,
                          "qmckl_set_ao_basis_exponent_omp_device",
                          "prim_num is not set");
  }
  ...
  if (ctx->ao_basis.exponent != NULL) {
    qmckl_exit_code rc =
        qmckl_free_omp_device(context, ctx->ao_basis.exponent, device_id);
    if (rc != QMCKL_SUCCESS) {
      return qmckl_failwith((qmckl_context)context, rc,
                            "qmckl_set_ao_basis_exponent_omp_device", NULL);
    }
...
qmckl_exit_code
qmckl_set_ao_basis_coefficient_omp_device(qmckl_context_device context,
                                      const double *coefficient,
                                      const int64_t size_max, int device_id) {
  if (qmckl_context_check((qmckl_context)context) == QMCKL_NULL_CONTEXT) {
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_CONTEXT,
                          "qmckl_set_ao_basis_coefficient_omp_device", NULL);
  }
  qmckl_context_struct *const ctx = (qmckl_context_struct *)context;
  ...
  if (prim_num <= 0L) {
    return qmckl_failwith((qmckl_context)context, QMCKL_FAILURE,
                          "qmckl_set_ao_basis_coefficient_omp_device",
                          "prim_num is not set");
  }
  ...
  if (ctx->ao_basis.coefficient != NULL) {
    qmckl_exit_code rc =
        qmckl_free_omp_device(context, ctx->ao_basis.coefficient, device_id);
    if (rc != QMCKL_SUCCESS) {
      return qmckl_failwith((qmckl_context)context, rc,
                            "qmckl_set_ao_basis_coefficient_omp_device", NULL);
    }
...
qmckl_exit_code qmckl_set_ao_basis_prim_factor_omp_device(qmckl_context context,
                                                          const double *prim_factor,
                                                          const int64_t size_max,
                                                          int device_id) {
  if (qmckl_context_check((qmckl_context)context) == QMCKL_NULL_CONTEXT) {
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_CONTEXT,
                          "qmckl_set_ao_basis_prim_factor_omp_device", NULL);
  }
  qmckl_context_struct *const ctx = (qmckl_context_struct *)context;
  ...
  if (prim_num <= 0L) {
    return qmckl_failwith((qmckl_context)context, QMCKL_FAILURE,
                          "qmckl_set_ao_basis_prim_factor_omp_device",
                          "prim_num is not set");
  }
  ...
  if (ctx->ao_basis.prim_factor != NULL) {
    qmckl_exit_code rc =
        qmckl_free_omp_device(context, ctx->ao_basis.prim_factor, device_id);
    if (rc != QMCKL_SUCCESS) {
      return qmckl_failwith((qmckl_context)context, rc,
                            "qmckl_set_ao_basis_prim_factor_omp_device", NULL);
    }
...
qmckl_set_ao_basis_ao_factor_omp_device(qmckl_context_device context,
  ...
  if (ao_num <= 0L) {
    return qmckl_failwith((qmckl_context)context, QMCKL_FAILURE,
                          "qmckl_set_ao_basis_ao_factor_omp_device",
                          "ao_num is not set");
  }
  ...
  if (ctx->ao_basis.ao_factor != NULL) {
    qmckl_exit_code rc =
        qmckl_free_omp_device(context, ctx->ao_basis.ao_factor, device_id);
    if (rc != QMCKL_SUCCESS) {
      return qmckl_failwith((qmckl_context)context, rc,
                            "qmckl_set_ao_basis_ao_factor_omp_device", NULL);
    }
  }
...
qmckl_exit_code qmckl_finalize_mo_basis_omp_device(qmckl_context_device context,
  ...
  if (qmckl_context_check((qmckl_context)context) == QMCKL_NULL_CONTEXT) {
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_CONTEXT,
                          "qmckl_finalize_mo_basis_omp_device", NULL);
  }
  ...
  if (ctx->mo_basis.coefficient_t != NULL) {
    qmckl_exit_code rc =
        qmckl_free_omp_device(context, ctx->mo_basis.coefficient_t, device_id);
    if (rc != QMCKL_SUCCESS) {
      return qmckl_failwith((qmckl_context)context, rc,
                            "qmckl_finalize_mo_basis_omp_device", NULL);
    }
...
qmckl_exit_code qmckl_set_mo_basis_mo_num_omp_device(qmckl_context_device context,
  ...
  if (mo_num <= 0) {
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_ARG_2,
                          "qmckl_set_mo_basis_mo_num_device", "mo_num <= 0");
  }
  ...
  if (ctx->mo_basis.provided) {
    qmckl_exit_code rc_ = qmckl_finalize_mo_basis_omp_device(context, device_id);
    if (rc_ != QMCKL_SUCCESS)
      return rc_;
  }
...
qmckl_exit_code qmckl_set_mo_basis_coefficient_omp_device(qmckl_context context,
                                                          const double *coefficient,
  ...
  if (mask != 0 && !(ctx->mo_basis.uninitialized & mask)) {
    return qmckl_failwith((qmckl_context)context, QMCKL_ALREADY_SET,
                          "qmckl_set_mo_basis_coefficient_omp_device", NULL);
  }

  if (ctx->mo_basis.coefficient != NULL) {
    qmckl_exit_code rc =
        qmckl_free_omp_device(context, ctx->mo_basis.coefficient, device_id);
    if (rc != QMCKL_SUCCESS) {
      return qmckl_failwith((qmckl_context)context, rc,
                            "qmckl_set_mo_basis_coefficient_omp_device", NULL);
    }
...
qmckl_exit_code
qmckl_trexio_read_electron_X_omp_device(qmckl_context_device context,
                                        trexio_t *const file) {
  ...
  qmckl_exit_code rc;
  rc = qmckl_set_electron_num_omp_device(context, up_num, dn_num);
  return rc;
}

qmckl_exit_code qmckl_trexio_read_nucleus_X_omp_device(qmckl_context_device context,
                                                       trexio_t *const file,
                                                       int device_id) {
  ...
  rc = qmckl_set_nucleus_num_omp_device(context, nucleus_num);
...

  {
    ...
    if (nucl_charge == NULL) {
      return qmckl_failwith((qmckl_context)context, QMCKL_ALLOCATION_FAILED,
                            "qmckl_trexio_read_nucleus_X_omp_device", NULL);
    }
    ...
    rc = qmckl_set_nucleus_charge_omp_device(context, nucl_charge, nucleus_num,
                                             device_id);
  ...
  rc = qmckl_set_nucleus_coord_omp_device((qmckl_context)context, 'N', nucl_coord,
                                          3 * nucleus_num, device_id);
...
#define MAX_STR_LEN 1024
  ...
  if (basis_type[0] == 'G') {
    rc = qmckl_set_ao_basis_type_omp_device(context, basis_type[0], device_id);
  } else {
    return qmckl_failwith((qmckl_context)context, QMCKL_FAILURE,
  ...
  assert(shell_num > 0);
  rc = qmckl_set_ao_basis_shell_num_omp_device(context, shell_num, device_id);
  ...
  assert(prim_num > 0);
  rc = qmckl_set_ao_basis_prim_num_omp_device(context, prim_num, device_id);
  ...
  if (rcio != TREXIO_SUCCESS) {
    return qmckl_failwith((qmckl_context)context, QMCKL_FAILURE,
                          "trexio_read_ao_num", trexio_string_of_error(rcio));
  }

  assert(ao_num > 0);
  rc = qmckl_set_ao_basis_ao_num_omp_device(context, ao_num, device_id);
...

  {
    ...
    if (nucleus_index == NULL) {
      return qmckl_failwith((qmckl_context)context, QMCKL_ALLOCATION_FAILED,
                            "qmckl_trexio_read_basis_nucleus_index_X_omp_device",
                            NULL);
    }
    ...
    /* Reformat data */
    rc = qmckl_set_ao_basis_nucleus_index_omp_device(context, nucleus_index,
                                                     nucleus_num, device_id);
    if (rc != QMCKL_SUCCESS) {
      qmckl_free_host(context, nucleus_index);
      nucleus_index = NULL;
      return rc;
...

  {
    ...
    if (nucleus_shell_num == NULL) {
      return qmckl_failwith(
          ...
          "qmckl_trexio_read_basis_nucleus_shell_num_X_omp_device", NULL);
    }
    ...
    if (tmp_array == NULL) {
      ...
      return qmckl_failwith((qmckl_context)context, QMCKL_ALLOCATION_FAILED,
                            "qmckl_trexio_read_basis_nucleus_shell_num_X_omp_device",
                            NULL);
    }
    ...
    /* Store data */
    rc = qmckl_set_ao_basis_nucleus_shell_num_omp_device(context, nucleus_shell_num,
                                                         shell_num, device_id);
...

  {
    ...
    if (shell_ang_mom == NULL) {
      return qmckl_failwith((qmckl_context)context, QMCKL_ALLOCATION_FAILED,
                            "qmckl_trexio_read_basis_shell_ang_mom_X_omp_device", NULL);
    }
    ...
    /* Read data */
    rcio =
        trexio_read_safe_basis_shell_ang_mom_32(file, shell_ang_mom, shell_num);
    if (rcio != TREXIO_SUCCESS) {
    ...
    /* Store data */
    rc = qmckl_set_ao_basis_shell_ang_mom_omp_device(context, shell_ang_mom,
                                                 shell_num, device_id);
...

  {
    ...
    if (shell_prim_num == NULL) {
      return qmckl_failwith((qmckl_context)context, QMCKL_ALLOCATION_FAILED,
                            "qmckl_trexio_read_basis_shell_prim_num_X_omp_device",
                            NULL);
    }
    ...
    if (tmp_array == NULL) {
      ...
      shell_prim_num = NULL;
      return qmckl_failwith((qmckl_context)context, QMCKL_ALLOCATION_FAILED,
                            "qmckl_trexio_read_basis_shell_prim_num_X_omp_device", NULL);
    }
    ...
    /* Store data */
    rc = qmckl_set_ao_basis_shell_prim_num_omp_device(context, shell_prim_num,
                                                  shell_num, device_id);
...

  {
    ...
    if (shell_prim_index == NULL) {
      return qmckl_failwith((qmckl_context)context, QMCKL_ALLOCATION_FAILED,
                            "qmckl_trexio_read_basis_shell_prim_index_X_omp_device", NULL);
    }
    ...
    /* Store data */
    rc = qmckl_set_ao_basis_shell_prim_index_omp_device(context, shell_prim_index,
                                                    shell_num, device_id);
...

  {
    ...
    if (shell_factor == NULL) {
      return qmckl_failwith((qmckl_context)context, QMCKL_ALLOCATION_FAILED,
                            "qmckl_trexio_read_basis_shell_factor_X_omp_device",
                            NULL);
    }
    ...
    /* Read data */
    rcio =
        trexio_read_safe_basis_shell_factor_64(file, shell_factor, shell_num);
    if (rcio != TREXIO_SUCCESS) {
    ...
    /* Store data */
    rc = qmckl_set_ao_basis_shell_factor_omp_device(context, shell_factor,
                                                shell_num, device_id);
...

  {
    ...
    /* Store data */
    rc = qmckl_set_ao_basis_exponent_omp_device(context, exponent, prim_num,
                                            device_id);
...

  {
    ...
    if (coefficient == NULL) {
      return qmckl_failwith((qmckl_context)context, QMCKL_ALLOCATION_FAILED,
                            "qmckl_trexio_read_basis_coefficient_X_omp_device",
                            NULL);
    }
    ...
    /* Store data */
    rc = qmckl_set_ao_basis_coefficient_omp_device(context, coefficient, prim_num,
                                                   device_id);
...

  {
    ...
    if (prim_factor == NULL) {
      return qmckl_failwith((qmckl_context)context, QMCKL_ALLOCATION_FAILED,
                            "qmckl_trexio_read_basis_prim_factor_X_omp_device",
                            NULL);
    }
    ...
    /* Read data */
    rc = qmckl_set_ao_basis_prim_factor_omp_device(context, prim_factor, prim_num,
                                                   device_id);
...

  {
    ...
    if (ao_normalization == NULL) {
      return qmckl_failwith((qmckl_context)context, QMCKL_ALLOCATION_FAILED,
                            "qmckl_trexio_read_ao_normalization_X_omp_device",
                            NULL);
    }
    ...
    /* Store data */
    rc = qmckl_set_ao_basis_ao_factor_omp_device(context, ao_normalization, ao_num,
                                             device_id);
...
qmckl_exit_code qmckl_trexio_read_mo_X_omp_device(qmckl_context_device context,
  ...
  rc = qmckl_get_ao_basis_ao_num_omp_device(context, &ao_num);
  if (rc != QMCKL_SUCCESS)
    return rc;
  ...
  if (rcio != TREXIO_SUCCESS) {
    return qmckl_failwith((qmckl_context)context, QMCKL_FAILURE,
                          "trexio_read_mo_num", trexio_string_of_error(rcio));
  }

  assert(mo_num > 0);
  rc = qmckl_set_mo_basis_mo_num_omp_device(context, mo_num, device_id);
...

  {
    ...
    if (mo_coef == NULL) {
      return qmckl_failwith((qmckl_context)context, QMCKL_ALLOCATION_FAILED,
                            "qmckl_trexio_read_mo_X_omp_device", NULL);
    }
    ...
    rc = qmckl_set_mo_basis_coefficient_omp_device(context, mo_coef, device_id);
...
qmckl_exit_code qmckl_trexio_read_omp_device(const qmckl_context_device context,
  ...
  if (file == NULL) {
    trexio_close(file);
    return qmckl_failwith((qmckl_context)context, QMCKL_INVALID_ARG_2,
                          "qmckl_trexio_read_omp_device",
                          trexio_string_of_error(rc));
  }

  assert(file != NULL);

  rc = qmckl_trexio_read_electron_X_omp_device(context, file);
  if (rc != QMCKL_SUCCESS) {
    trexio_close(file);
    return qmckl_failwith((qmckl_context)context, QMCKL_FAILURE,
                          "qmckl_trexio_read_omp_device", "Error reading electron");
  }

  rc = qmckl_trexio_read_nucleus_X_omp_device(context, file, device_id);
  if (rc != QMCKL_SUCCESS) {
    trexio_close(file);
    return qmckl_failwith((qmckl_context)context, QMCKL_FAILURE,
                          "qmckl_trexio_read_omp_device", "Error reading nucleus");
  }

  rc = qmckl_trexio_read_ao_X_omp_device(context, file, device_id);
  if (rc != QMCKL_SUCCESS) {
    trexio_close(file);
    return qmckl_failwith((qmckl_context)context, QMCKL_FAILURE,
                          "qmckl_trexio_read_omp_device", "Error reading AOs");
  }

  rc = qmckl_trexio_read_mo_X_omp_device(context, file, device_id);
  if (rc != QMCKL_SUCCESS) {
    trexio_close(file);
    return qmckl_failwith((qmckl_context)context, QMCKL_FAILURE,
