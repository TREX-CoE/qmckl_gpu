// This file will contains general functions accepting a qmckl_contect_device as argument,
// hence why they need a device alternative
                      ...
                      const char* message)
{
  ...
  if (message == NULL) {
    qmckl_exit_code rc =
      qmckl_set_error_device(context, exit_code, function, qmckl_string_of_error(exit_code));
