...
/* Interfaces */
/*  #  #+CALL:
 * generate_c_header(table=qmckl_ao_value_args_doc,rettyp=get_value("CRetType"),fname="qmckl_compute_ao_value"))
 */
...
/* Interfaces */
/*  #  #+CALL:
 * generate_c_header(table=qmckl_ao_vgl_args_doc,rettyp=get_value("CRetType"),fname="qmckl_compute_ao_vgl"))
 */
/*  #  (Commented because the header needs to go into h_private_func) */
